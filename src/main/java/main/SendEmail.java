...
public class SendEmail
{
    ...
    public static String myEmailAccount = "daixuyang97@vip.qq.com";
    public static String myEmailPassword = "roavailgdurubebi";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "57243945@qq.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "小代", "UTF-8"));
